...
- Check the *Updated* branch  or *Releases* link for latest versions, I plan on moving the current branch to a branch called *Older* for older code; Also, I'm planning on creating a *Dev* branch for *pull requests*.

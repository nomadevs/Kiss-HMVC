...
> **UPDATES** - A bit of rewrite of the framework. The framework now has a working Singleton ( that acts as a super object, just like CodeIgniter ! ) instead of a Registry class. **[10/21/19]**

### PLEASE READ:
- Check back often for updates. 
- Check if there's any activity before downloading!
- Check the *Issues* tab for current issues.
- Check the *Updated* branch  or *Version(s)* link for latest versions, I plan on moving the current branch to a branch called *Older* for older code; Also, I'm planning on creating a *Dev* branch for *pull requests*.
...
## Contact
Feel free to get in touch with me via my website: <https://www.citrusdevs.x10.bz> and my email: <philosaphylas@gmail.com>!
